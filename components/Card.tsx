...
export default function Card() {
  return (
    <div className='flex flex-col space-y-4 bg-white rounded w-full p-4 border'>
      ...
      <p className='text-lg text-slate-600 line-clamp-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus corporis laudantium quis explicabo quasi incidunt asperiores, voluptatum rerum perferendis ipsum. </p>
